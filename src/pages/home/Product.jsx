...
export function Product({ product, loadCartItems }) {
  ...
  return (
    <div className="product-container" data-testid="product-container" key={product.id}>
      ...
      <div className="product-quantity-container">
        <select value={quantity} data-testid="quantity-selector" onChange={selectQuantity}>
